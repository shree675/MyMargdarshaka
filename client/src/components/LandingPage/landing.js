  ...
  return (
    <div className="landing-body">
      <button
        ...
        onClick={() => (window.location = "/common-guidelines")}
      >
      ...
      <div className="landing-content2">
        <span className="landing-bottom-name">MyMargdarshaka</span> is your
        first step to education and enlightenment! Are you a school student but
        are unable to attend traditional school? OR, Are you someone who wants
        to give back by teaching and mentoring students but cannot reach
        traditional schools? We connect students and mentors who cannot avail
        traditional schools for various financial and logistical reasons.
        Mentors and students associate with the National Institute of Open
        Schooling (NIOS) by the Government of India to complete class 10 and
        Class 12 certification. Get Started to be a part of My Margdarshaka as a
        learner or a mentor!
