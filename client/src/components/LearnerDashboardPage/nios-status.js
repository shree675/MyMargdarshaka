...
const NIOSStatus = () => {
  return (
    <div className="nios-status mb-3">
      <div className="container mx-auto card mt-3" style={{border: "1px solid #FF0000", borderRadius: "20px"}}>
      <h1 className="m-3" style={{ color: "#5D1049" }}>
        <strong>NIOS Status</strong>
      </h1>
        <div className="row">
          <div className="col">
            <button className="btn rounded-pill m-3 p-3" style={{ borderColor: "#5D1049" }}>
