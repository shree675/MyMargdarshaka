...
const LearnerRequestChangeOfMentor = ({ changeMentor }) => {
  ...
  return (
    <div className='request-change-of-mentor card p-3' style={{ border: "1px solid #FF0000", borderRadius: "20px" }}>
      ...
      <SubjectTitle style={style} subject='Mathematics' changeMentor={changeMentor} />
      ...
      <SubjectTitle style={style} subject='Science' changeMentor={changeMentor} />
      ...
      <SubjectTitle style={style} subject='English' changeMentor={changeMentor} />
