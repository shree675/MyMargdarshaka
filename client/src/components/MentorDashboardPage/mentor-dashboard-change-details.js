...
const LearnerDashboardChangeDetails = ({ details }) => {
  ...
  const handleClick = async () => {
    ...
    validate();
    // update DB
    console.log("state in handle Click : ", state, " mentor id : ", details._id);
    await axios
    ...
    <div className='learner-dashboard-change-details'>
      <div className='card px-4 py-5 mt-3 mx-md-0 mx-auto' style={{ borderRadius: "20px", borderColor: "#FF0000" }}>
        ...
        <form className='needs-validation' noValidate>
          ...
          <div class='input-group mb-3'>
            <input id='phone' type='text' class='form-control' placeholder='9876543210' value={state.phone} required readOnly />
            <div className='valid-feedback'>Looks good!</div>
