        ...
        <div className="init-signin-left">
          ...
          <div className="init-signin-left-content">
            ...
            <div className="init-signin-text1">
              When you sign up as a Learner, you are connected with real mentors
              for each subject that you want to learn. Your mentors can reach
              you via your contact number or email address. Sign up and take the
              first step towards education and success!
            </div>
          </div>
        ...
        <div className="init-signin-right">
          <div className="init-signin-left-content">
            <div className="init-signin-text2">
              When you sign up as a Mentor, you are connected with real learners
              who you can guide through their senior secondary education. Sign
              up and take the first step towards making an invaluable
              contribution in someone’s life!
            </div>
            <button
              className="init-signin-button"
              onClick={() => {
